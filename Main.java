...
public class Main {
    ...
    automobiles = new Automobile[] {
                new Automobile(" ","Granta", 1.7, "Yellow",2015,"Russia"),
                new Automobile("Audi","A8 50 L TDI quattro", 3.0,"Black",2020,"Germany"),
                new Automobile("BMW","Z8",3.0,"Black",2021,"Germany"),
                new Automobile(null,"Sportage 4th generation",2.4,"Red",2018,"South Korea"),
                new Automobile("Hyundai","Avante",1.6, null,2016,"South Korea")
                };
